...
logger = getLogger("PiCast.project")
logger.debug("The hostname of this machine is: {}".format(hostname))
logger.debug("The uuid of this machine is: {}".format(uuidstr))
logger.debug("The dnsstr of this machine is: {}".format(dnsstr))
os.system(dnsstr+' &')
